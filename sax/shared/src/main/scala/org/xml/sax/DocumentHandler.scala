 ...
 * SAX2, it has been replaced by {@link ContentHandler ContentHandler},
 * which provides Namespace support and reporting of skipped entities.
 * This interface is included in SAX2 only to support legacy SAX1 applications.</p>
 *
 ...
 * @see HandlerBase
 */
// TODO: DBO => delete me? (replaced by ContentHandler)
@deprecated trait DocumentHandler {
