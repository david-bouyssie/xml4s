...
object XMLConstants {
   ...
   *      Namespaces in XML, 3. Qualified Names</a>
   */
  val XML_NS_URI = "http://www.w3.org/XML/1998/namespace"
  /**
   ...
   *      Namespaces in XML, 3. Qualified Names</a>
   */
  val XML_NS_PREFIX = "xml"
  /**
   * <p>The official XML attribute used for specifying XML Namespace
   * declarations, {@link #XMLNS_ATTRIBUTE XMLConstants.XMLNS_ATTRIBUTE}, Namespace name URI.</p>
   *
   * <p>Defined by the XML specification to be
   ...
   */
  val XMLNS_ATTRIBUTE_NS_URI = "http://www.w3.org/2000/xmlns/"
  /**
   * <p>The official XML attribute used for specifying XML Namespace
   * declarations.</p>
   *
   ...
   */
  val W3C_XML_SCHEMA_NS_URI = "http://www.w3.org/2001/XMLSchema"
  /**
   ...
   *      Structures, 2.6 Schema-Related Markup in Documents Being Validated</a>
   */
  val W3C_XML_SCHEMA_INSTANCE_NS_URI = "http://www.w3.org/2001/XMLSchema-instance"
  /**
   ...
   */
  val W3C_XPATH_DATATYPE_NS_URI = "http://www.w3.org/2003/11/xpath-datatypes"
  /**
   ...
   */
  val XML_DTD_NS_URI = "http://www.w3.org/TR/REC-xml"
  /**
   ...
   */
  val RELAXNG_NS_URI = "http://relaxng.org/ns/structure/1.0"
  /**
   ...
   * </ul>
   */
  val FEATURE_SECURE_PROCESSING = "http://javax.xml.XMLConstants/feature/secure-processing"
}