...
object XmlPullParser {
   ...
   */
  val TYPES = Array("START_DOCUMENT", "END_DOCUMENT", "START_TAG", "END_TAG", "TEXT", "CDSECT", "ENTITY_REF", "IGNORABLE_WHITESPACE", "PROCESSING_INSTRUCTION", "COMMENT", "DOCDECL")
  /**
...
trait XmlPullParser {
   ...
   */
  @throws[XmlPullParserException]
  def setInput(inputStream: InputStream, inputEncoding: String): Unit
   ...
   */
  @throws[XmlPullParserException]
  def defineEntityReplacementText(entityName: String, replacementText: String): Unit
   ...
   */
  @throws[XmlPullParserException]
  def getNamespacePrefix(pos: Int): String
   ...
   */
  @throws[XmlPullParserException]
  def getNamespaceUri(pos: Int): String
   ...
   */
  def getTextCharacters(holderForStartAndLength: Array[Int]): Array[Char]
   ...
   */
  def isAttributeDefault(index: Int): Boolean
