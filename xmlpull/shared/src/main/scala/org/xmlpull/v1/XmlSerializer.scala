...
trait XmlSerializer {
  ...
  def setFeature(name: String, state: Boolean): Unit
   ...
   */
  @throws[IllegalArgumentException]
  def getPrefix(namespace: String, generatePrefix: Boolean): String
  ...
  @throws[IllegalArgumentException]
  @throws[IllegalStateException]
  def startTag(namespace: String, name: String): XmlSerializer
  ...
  @throws[IllegalArgumentException]
  @throws[IllegalStateException]
  def attribute(namespace: String, name: String, value: String): XmlSerializer
  ...
  @throws[IllegalArgumentException]
  @throws[IllegalStateException]
  def endTag(namespace: String, name: String): XmlSerializer
  ...
  @throws[IllegalArgumentException]
  @throws[IllegalStateException]
  def text(text: String): XmlSerializer

  @throws[IOException]
  @throws[IllegalArgumentException]
  @throws[IllegalStateException]
  def text(buf: Array[Char], start: Int, len: Int): XmlSerializer

  @throws[IOException]
  @throws[IllegalArgumentException]
  @throws[IllegalStateException]
  def cdsect(text: String): Unit

  @throws[IOException]
  @throws[IllegalArgumentException]
  @throws[IllegalStateException]
  def entityRef(text: String): Unit

  @throws[IOException]
  @throws[IllegalArgumentException]
  @throws[IllegalStateException]
  def processingInstruction(text: String): Unit
  ...
  @throws[IllegalArgumentException]
  @throws[IllegalStateException]
  def docdecl(text: String): Unit

  @throws[IOException]
  @throws[IllegalArgumentException]
  @throws[IllegalStateException]
  def ignorableWhitespace(text: String): Unit
